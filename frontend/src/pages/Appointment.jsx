...
const Appointment = () => {
  ...
  const [slotIndex, setSlotIndex] = useState(0)  // Fixed: changed from useEffect to useState
  ...
  //  if (!docInfo) return; // Add null check
  ...
  try {
    ...
    if (data.success) {
      toast.success(data.message)  // ✅ Fixed here
      getDoctorsData()
  ...
  }, [docInfo]) // Added docInfo dependency
